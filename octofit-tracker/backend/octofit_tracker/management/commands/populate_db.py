...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        # Skipping deletion due to Djongo ObjectId bug. Only insert test data.
        ...
        w2 = Workout.objects.create(name='Flight Training', description='Flight skills for heroes', suggested_for='DC')
